...
import { Building2, Plus, X, Save, CheckCircle2, Users, ClipboardList, UserCircle } from "lucide-react";
...
export default function AteliersPage() {
  const { data, isPending, isError, error, refetch } = useAteliersQuery();
  ...
  return (
    <div className="space-y-5">
      ...
      {data && data.length === 0 && (
        <EmptyState icon={Building2}>Aucun atelier pour l'instant — créez le premier.</EmptyState>
      )}
